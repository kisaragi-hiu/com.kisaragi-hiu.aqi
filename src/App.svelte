<script lang="ts">
  import AQI from "./components/AQI.svelte";
  import Updated from "./components/Updated.svelte";
  import Location from "./components/Location.svelte";
  import OtherData from "./components/OtherData.svelte";
  import StationList from "./components/StationList.svelte";
  let PublishTime = "2021/05/16 05:00:00";
  let sites = [
    {
      SiteName: "基隆",
      County: "基隆市",
      ...
      WindSpeed: "0.8",
      WindDirec: "267",
      PublishTime: "2021/05/20 02:00:00",
      "PM2.5_AVG": "15",
      PM10_AVG: "30",
      SO2_AVG: "3",
      ...
      Latitude: "25.129167",
      SiteId: "1",
      ImportDate: "2021-05-20 03:02:08.050000",
    },
    {
      SiteName: "汐止",
      County: "新北市",
    ...
    },
    {
      ...
      PM10_AVG: "36",
      SO2_AVG: "6",
      Longitude: "121.30872222",
      Latitude: "24.98677778",
      SiteId: "17",
      ImportDate: "2021-05-20 03:02:08.050000",
    },
    {
    ...
    },
    {
      ...
      PM10_AVG: "25",
      SO2_AVG: "1",
      Longitude: "120.24781111",
      Latitude: "23.46712222",
      SiteId: "40",
      ImportDate: "2021-05-20 03:02:08.050000",
    },
    {
    ...
    },
    {
      ...
      PM10_AVG: "28",
      SO2_AVG: "2",
      Longitude: "120.58178611",
      Latitude: "23.95058333",
      SiteId: "201",
      ImportDate: "2021-05-20 03:02:08.050000",
    },
    {
    ...
    },
    {
      ...
      PM10_AVG: "21",
      SO2_AVG: "1",
      Longitude: "120.54303333",
      Latitude: "22.54779444",
      SiteId: "310",
      ImportDate: "2021-05-20 03:02:08.050000",
    },
    {
...
<Location {county} {siteName} />
<AQI AQI="{site.AQI}" />
<OtherData {site} />
<footer>
  <p>資料來自<a href="https://data.gov.tw/">政府資料開放平臺</a>。</p>
  <p>
    <a href="https://github.com/kisaragi-hiu/com.kisaragi-hiu.aqi">原始碼</a
    >以MIT條款釋出。
  </p>
  <Updated timestamp="{PublishTime}" />
</footer>
<!-- See https://svelte.dev/examples#event-forwarding -->
<!-- <StationList {sites} on:switchSite="{handleSwitchSite}" /> -->
<StationList {sites} />
